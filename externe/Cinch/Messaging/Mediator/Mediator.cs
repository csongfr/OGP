...
namespace Cinch
{
    ...
    public class Mediator
    {
        ...
        public void Register(string signal, Delegate callback)
        {
            ...
            invocationList.AddAction(signal, callback.Target,
        ...
        public void NotifyColleagues<T>(string signal, T parameter)
        {
            var actions = invocationList.GetActions(signal);
        ...
        /// <param name="signal">The message to lookup weak callbacks
        /// for</param>
        public void NotifyColleagues<T>(string signal)
        {
            var actions = invocationList.GetActions(signal);
